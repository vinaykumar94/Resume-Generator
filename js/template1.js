...
function printResume() {
    alert("Untick Header and Footer in Options in Print Menu to remove unwanted details!!");
    alert("Use Pages Option to Print First 2 pages in Print Menu eg: give paper as 1-2");
    alert("Thank You for Choosing Resume Generator !! Have an Awesome Day !! Visit again !!!");
    window.print();
    };
