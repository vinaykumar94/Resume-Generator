...
//Validating Forms for user Input
...
$(document).ready(function(){
    ...
    var f= $("#address1").val().length;
    var g= $("#address2").val().length;
    var h= $("#address3").val().length;

    if((a==0)&&(b==0)&&(c==0)&&(d==0)&&(e==0)&&(f==0)&&(g==0)&&(h==0)){
              alert("Please Enter all the Basic Information to Continue");
              $("#personal").hide();
              $("#basic").show();              
           }
              ...
              alert("Please Enter the State and Pincode");
              $("#personal").hide();
              $("#basic").show();              
           }
           else if(((a==0)&&(b==0)&&(c==0))&&((d==0)&&(e>0)&&(f>0)&&(g>0)&&(h>0))){
